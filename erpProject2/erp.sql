...
CREATE TABLE tunit(
UnitID VARCHAR(10) PRIMARY KEY COMMENT'单位编号',
...
ClassID VARCHAR(20) PRIMARY KEY COMMENT'类别编号',
...
LineNo INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT'行号',
...
SalesID VARCHAR(20) NOT NULL COMMENT '请购人员',
